    ...
    <div class="collections">
      <div class="collections-container">
        <div class="collections-header">
          <h1 class="brand-primary">Shop</h1>
        </div>
        ...
        <div v-else>
          ...
          <div class="collections-filters">
            ...
            <!-- <div class="slider-container">
					<div
					  id="slider"
					  class="noUi-extended noUi-target noUi-ltr noUi-horizontal">
					  <div class="noUi-base">
...
const fetchAll = async () => {
  try {
    ...
    availableCategories.value = [...new Set(data.map((item) => item.category))];
...
const initPriceSlider = () => {
  ...
  if (slider) {
    ...
    // Update the selected price range when slider value changes
    slider.noUiSlider.on("update", (values) => {
      selectedPriceRange.value = values.map(Number);
      applyFilters();
    });
  } else {
